...
if [ "$CC_SRC_PATH" = "NA" ]; then
	...
	if [ "$CC_NAME" = "basic" ]; then
		...
		# !!!!!! insert option for cert chaincode !!!!!!!
	elif [ "$CC_NAME" = "cert" ]; then
		echo $'\e[0;32m'asset-transfer-basic$'\e[0m' chaincode
		CC_SRC_PATH="../asset-transfer-basic"
		# !!!!!! insert option for updatedcert chaincode !!!!!!!
	elif [ "$CC_NAME" = "updatedcert" ]; then
		echo $'\e[0;32m'asset-transfer-basic$'\e[0m' chaincode
		CC_SRC_PATH="../asset-transfer-basic"
	...
	if [ "$CC_SRC_LANGUAGE" = "go" ]; then
		...
		# !!!!!!! insert option for cert chaincode !!!!!!
	elif [ "$CC_SRC_LANGUAGE" = "cert-contract" ]; then
		CC_SRC_PATH="$CC_SRC_PATH/certificate-transfer-contract/"
